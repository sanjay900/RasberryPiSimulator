...
public class Simbad extends JFrame implements ActionListener {
    ...
    World world;
    Simulator simulator;
    Console console=new Console(200,200);
    ...
    private void createInternalFrames() {
        ...
        console.setLocation(20, 550);
        console.setAutoscrolls(true);
        worldWindow.show();
        worldWindow.setLocation(350, 20);
        ...
        controlWindow.show();
        controlWindow.setLocation(350, 430);
        }
    }
    /**
    ...
    private void runBackgroundMode(){
        ...
        System.out.println("World is rendered very rarely. ecs100.UI is disabled");
        System.out.println("--------------------------------------------");
        // slow down
