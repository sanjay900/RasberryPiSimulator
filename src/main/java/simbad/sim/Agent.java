...
public class Agent extends SimpleAgent {
   ...
   protected void resetPosition(){
    ...
    protected void create3D(){
        ...
        material.setSpecularColor(BaseObject.black);
       ...
       /* // allow geom intersect on each geom of the primitive cylinder
	    ...
	    appear.setMaterial(new Material(color2, BaseObject.black,
	                                  color2, BaseObject.white, 100.0f));
    ...
    /**
     * Add a ecs100.UI panel to the agent. Typically used for displaying behavior outputs.
    ...
    /**
     * Returns the ecs100.UI panel previously set with <code>setUIPanel</code>
     * @return the panel
     */
    ...
    /** Creates the ecs100.UI that may be associated to the agent.
