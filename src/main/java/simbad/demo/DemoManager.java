...
public class DemoManager {
    ...
    final static String classNames[] = { "BaseDemo","BumpersDemo",
            "SingleAvoiderDemo", "AvoidersDemo",
            "ImagerDemo", "LightSearchDemo",
            "SimplestDemo", "BlinkingLampDemo",
            "DifferentialKinematicDemo","KheperaDemo","PickCherriesDemo",
            "PushBallsDemo"};
